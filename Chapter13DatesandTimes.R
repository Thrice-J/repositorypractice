...
flights1
#make_datetime is used to convert
view(flights1)
...
flights_dt
#note end_with selects all that ends with delay and time
view(flights_dt)
...
#Note this does not actually change variable datetime like above examples
...
(today() %--% next_year)%/%days(1)
    #note %/% is integer division if using other intervals that aren't
    #exact drop the % for more accuracy. 
